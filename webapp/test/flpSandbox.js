		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commonfileupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commonfileupload-display": {
								"semanticObject": "commonfileupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=commonfileupload",
									"url": sap.ui.require.toUrl("commonfileupload")
								}
							}
						}
					}
